    ...
    public List<PenggunaModel> getData() {
        ...
        try {
            ...
            while (rs.next()){
                ...
                penggunaModel.setPassword("Rahasia :)");
...
//                penggunaModel.setPassword(rs.getString("password"));
    ...
    @Override
    public boolean validateOldPassword(String username, String passLama) {
        String encryptedOldPass = Encrypt.getmd5java(passLama);
        ...
        try{
            ...
            st.setString(2, encryptedOldPass);
    ...
    @Override
    public boolean changePassword(String username, String passLama, String passBaru) {
        
        String encryptedOldPass = Encrypt.getmd5java(passLama);
        String encryptedNewPass = Encrypt.getmd5java(passBaru);
        ...
        try{
            ...
            if (rs.next()){
                ...
                stUpdate.setString(1, encryptedNewPass);
