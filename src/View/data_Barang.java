...
public class data_Barang extends javax.swing.JDialog {
    ...
    private SepatuTableMod tblModels = new SepatuTableMod();
    ...
    public data_Barang(java.awt.Frame parent, boolean modal) {
        ...
        tb_dataBarang.setModel(tblModels);
        loadData();
    ...
    private void loadData() {
        ...
        tblModels.setData(list);
    }
    
    private void selectData() {
        int row = tb_dataBarang.getSelectedRow();
        
        sptModel.setIdSepatu(tb_dataBarang.getModel().getValueAt(row, 1).toString());
        sptModel.setNamaSepatu(tb_dataBarang.getModel().getValueAt(row, 3).toString());
        sptModel.setHarga(Double.parseDouble(tb_dataBarang.getModel().getValueAt(row, 7).toString()));
